        ...
        setContent {
            RoomGetDataTheme {
                Surface(
                    ...
                    var searchText by remember { mutableStateOf("") }
                    var clickSearch by remember { mutableStateOf(false) }
//                    var searchList by remember { mutableStateOf<List<User>>(emptyList()) }
//                    var searchList: User?
//                    val searchList by db.userDao().get(searchVal).collectAsState(initial = emptyList())
...
//                                        val searchEmail = userList.find { it.email == searchText }
//
//                                        if (clickSearch && (searchName != null || searchPhone != null || searchEmail != null)) {
////                                        if (clickSearch && (searchText != "") {
////                                        if (clickSearch && searchText != "" ) {
//
//                                            searchList.clear()
//                                            searchList.addAll(
...
//                                        }
                            ...
                            Column {
                                ...
                                val list = userList.filter {
                                    if (clickSearch) {
                                        it.name == searchText || it.phone == searchText || it.email == searchText
                                    } else {
                                        true
                                    }
                                }
//                                val list = if (clickSearch) {searchList} else  {userList}
...
//                            } else {}
                            if (searchText != "") {
                                scope.launch(Dispatchers.IO) {
                                    db.userDao().deleteAllByCondition(
                                        deleteUser?.name!!,
                                        deleteUser?.phone!!,
                                        deleteUser?.email!!
                                    )
        ...
        setContent {
            RoomGetDataTheme {
                Surface(
                    ...
                    val currentUid = intent.getIntExtra("currentUid", 0)
                ...
                onClick = {
                   ...
                   if (editUser != null) {
                        if (editName.isNotEmpty()) {
                            //update가 인자를 하나만 받는 이유는 받은 인자에 값을 덮어씌우기 때문
...
//        Button(onClick = {
//            clickDelete = true
//            val deleteUser = userList.find { it.name == "dd" }
////            deleteUser?.let{
////                scope.launch(Dispatchers.IO) {
////                    db.userDao().delete(it)
////                }
...
fun UpdateUser(uid: Int) {
    ...
    Column(
        ...
        Row {
            ...
            Button(
                onClick = {
                    val editUser = userList.find { it.uid == uid }!!
//                    var updateUser = editUser.copy()
